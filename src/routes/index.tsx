...
function Home() {
  ...
  return <div className="mx-auto max-w-7xl px-5 py-8 lg:px-8 lg:py-14">
    ...
    <RecommendationRow title="Available Now" subtitle="40 seats available nearby" cafes={cafes.slice(1,4)} />
    ...
    <RecommendationRow title="Hidden Gems" subtitle="Students from other faculties are discovering these" cafes={[getCafe("the-study-club"), getCafe("fib-corner-coffee"), getCafe("library-brew")]} />
